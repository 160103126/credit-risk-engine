...
def get_monotone_constraints(X, cat_cols):
    """
    Set monotonic constraints: credit_score -1 (lower risk)
    """
...
def train_model(X_train, y_train, X_val, y_val, cat_cols, config, log_mlflow=True):
    """
    Train LightGBM model with optional MLflow tracking.
    """
